/*! jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license */ !(function(
    ...
    var M = function(a) {
            ...
            return 1 !== c && 9 !== c ?
                !1 :
                !b || (b !== !0 && a.getAttribute("classNameid") === b);
        },
        N = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
        O = /([A-Z])/g;
    ...
    n.fn.extend({
            addclassName: function(a) {
                ...
                if (n.isFunction(a))
                    return this.each(function(b) {
                        n(this).addclassName(a.call(this, b, Cb(this)));
                    });
                if ("string" == typeof a && a) {
                    ...
                    while ((c = this[i++]))
                        if (
                            ...
                            (h = n.trim(d)), e !== h && n.attr(c, "className", h);
                        }
                }
                return this;
            },
            removeclassName: function(a) {
                ...
                if (n.isFunction(a))
                    return this.each(function(b) {
                        n(this).removeclassName(a.call(this, b, Cb(this)));
                    });
            ...
            toggleclassName: function(a, b) {
                ...
                return "boolean" == typeof b && "string" === c ?
                    ...
                    n.isFunction(a) ?
                    this.each(function(c) {
                        n(this).toggleclassName(a.call(this, c, Cb(this), b), b);
                    }) :
                    this.each(function() {
                        var b, d, e, f;
                        if ("string" === c) {
                            ...
                            while ((b = f[d++]))
                                e.hasclassName(b) ? e.removeclassName(b) : e.addclassName(b);
                        } else(void 0 !== a && "boolean" !== c) || ((b = Cb(this)), b && n._data(this, "__className__", b), n.attr(this, "className", b || a === !1 ? "" : n._data(this, "__className__") || ""));
                    });
            },
