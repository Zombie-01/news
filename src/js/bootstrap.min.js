        ...
        ((function(t) {
                    ...
                    _ = (function() {
                        ...
                        return (
                            ...
                            (e.prototype._removeElement = function(e) {
                                var n = this;
                                return (
                                    t(e).removeclassName(f.SHOW),
                                    r.supportsTransitionEnd() && t(e).hasclassName(f.FADE) ?
                                    void t(e)
            ...
            (function(t) {
                                ...
                                if (n) {
                                    ...
                                    if (i) {
                                        if ("radio" === i.type)
                                            if (
                                                i.checked &&
                                                t(this._element).hasclassName(h.ACTIVE)
                                            )
                                                e = !1;
                                            else {
                                                var o = t(n).find(c.ACTIVE)[0];
                                                o && t(o).removeclassName(h.ACTIVE);
                                            }
                                        e &&
                                            ((i.checked = !t(this._element).hasclassName(h.ACTIVE)),
                                                t(i).trigger("change")),
                                            i.focus();
                                    }
                                }
                                this._element.setAttribute(
                                        "aria-pressed", !t(this._element).hasclassName(h.ACTIVE)
                                    ),
                                    e && t(this._element).toggleclassName(h.ACTIVE);
                            }),
                            (e.prototype.dispose = function() {
                ...
                return (
                    ...
                    .on(u.CLICK_DATA_API, c.DATA_TOGGLE_CARROT, function(e) {
                        e.preventDefault();
                        var n = e.target;
                        t(n).hasclassName(h.BUTTON) || (n = t(n).closest(c.BUTTON)),
                            d._jQueryInterface.call(t(n), "toggle");
                    })
                    .on(u.FOCUS_BLUR_DATA_API, c.DATA_TOGGLE_CARROT, function(e) {
                        var n = t(e.target).closest(c.BUTTON)[0];
                        t(n).toggleclassName(h.FOCUS, /^focus(in)?$/.test(e.type));
                    }),
                        ...
                        return (
                            ...
                            (h.prototype._slide = function(e, n) {
                                ...
                                if (!d.isDefaultPrevented() && o && s) {
                                    ...
                                    r.supportsTransitionEnd() &&
                                        t(this._element).hasclassName(E.SLIDE) ?
                                        (t(s).addclassName(h),
                                            r.reflow(s),
                                            t(o).addclassName(l),
                                            t(s).addclassName(l),
                                        ...
                                        (t(o).removeclassName(E.ACTIVE),
                                            t(s).addclassName(E.ACTIVE),
                                            (this._isSliding = !1),
                            ...
                            (h._dataApiClickHandler = function(e) {
                                ...
                                if (n) {
                                    var i = t(n)[0];
                                    if (i && t(i).hasclassName(E.CAROUSEL)) {
                    ...
                    E = (function() {
                        ...
                        return (
                            (l.prototype.toggle = function() {
                                t(this._element).hasclassName(g.SHOW) ?
                                    this.hide() :
                                    this.show();
                            }),
                            (l.prototype.show = function() {
                                ...
                                if (!t(this._element).hasclassName(g.SHOW)) {
                                    var n = void 0,
                                        i = void 0;
                                    if (
                                        (this._parent &&
                                            ((n = t.makeArray(t(this._parent).find(m.ACTIVES))),
                                                n.length || (n = null)), !(n && ((i = t(n).data(a)), i && i._isTransitioning)))
                                    ) {
                                        ...
                                        if (
                                            ...
                                            t(this._element)
                                                .removeclassName(g.COLLAPSE)
                                                .addclassName(g.COLLAPSING),
                                                (this._element.style[s] = 0),
                                                this._element.setAttribute("aria-expanded", !0),
                                                this._triggerArray.length &&
                                                t(this._triggerArray)
                                                .removeclassName(g.COLLAPSED)
                                                .attr("aria-expanded", !0),
                                                this.setTransitioning(!0);
                                            var h = function() {
                                                t(e._element)
                                                    .removeclassName(g.COLLAPSING)
                                                    .addclassName(g.COLLAPSE)
                                                    .addclassName(g.SHOW),
                                                    (e._element.style[s] = ""),
                                ...
                                if (t(this._element).hasclassName(g.SHOW)) {
                                    ...
                                    if (
                                        ...
                                        r.reflow(this._element),
                                            ...
                                            .addclassName(g.COLLAPSING)
                                            .removeclassName(g.COLLAPSE)
                                            .removeclassName(g.SHOW),
                                            this._element.setAttribute("aria-expanded", !1),
                                            this._triggerArray.length &&
                                            t(this._triggerArray)
                                            .addclassName(g.COLLAPSED)
                            ...
                            (l.prototype._getDimension = function() {
                                var e = t(this._element).hasclassName(p.WIDTH);
                            ...
                            (l.prototype._getParent = function() {
                                ...
                                return (
                                    ...
                                    .find(i)
                                    .each(function(t, n) {
                                        e._addAriaAndCollapsedclassName(
                                            l._getTargetFromElement(n), [n]
                                        );
                                    }),
                                    n
                                );
                            ...
                            (l.prototype._addAriaAndCollapsedclassName = function(e, n) {
                                if (e) {
                                    var i = t(e).hasclassName(g.SHOW);
                                    e.setAttribute("aria-expanded", i),
                                        n.length &&
                                        t(n)
                                        .toggleclassName(g.COLLAPSED, !i)
            ...
            (function(t) {
                var e = "dropdown",
                    ...
                    m = (function() {
                        ...
                        return (
                            (e.prototype.toggle = function() {
                                if (this.disabled || t(this).hasclassName(g.DISABLED))
                                    return !1;
                                var n = e._getParentFromElement(this),
                                    i = t(n).hasclassName(g.SHOW);
                                ...
                                var r = { relatedTarget: this },
                                    s = t.Event(_.SHOW, r);
                                return (
                                    t(n).trigger(s), !s.isDefaultPrevented() &&
                                    (this.focus(),
                                        this.setAttribute("aria-expanded", !0),
                                        t(n).toggleclassName(g.SHOW),
                                        t(n).trigger(t.Event(_.SHOWN, r)), !1)
                                );
                            }),
                            (e.prototype.dispose = function() {
                            ...
                            (e._dataApiKeydownHandler = function(n) {
                                if (
                                    ...
                                    !/input|textarea/i.test(n.target.tagName) &&
                                    (n.preventDefault(),
                                        n.stopPropagation(), !this.disabled && !t(this).hasclassName(g.DISABLED))
                                ) {
                                    var i = e._getParentFromElement(this),
                                        o = t(i).hasclassName(g.SHOW);
                    ...
                    v = (function() {
                        ...
                        return (
                            ...
                            (h.prototype.show = function(e) {
                                ...
                                r.supportsTransitionEnd() &&
                                    t(this._element).hasclassName(m.FADE) &&
                                ...
                                t(this._element).trigger(i),
                                    ...
                                    ((this._isShown = !0),
                                        ...
                                        this._setScrollbar(),
                                        t(document.body).addclassName(m.OPEN),
                            ...
                            (h.prototype.hide = function(e) {
                                ...
                                t(this._element).trigger(o),
                                    ...
                                    ((this._isShown = !1),
                                        ...
                                        t(this._element).removeclassName(m.SHOW),
                            ...
                            (h.prototype._showElement = function(e) {
                                ...
                                document.body.appendChild(this._element),
                                    ...
                                    t(this._element).addclassName(m.SHOW),
                            ...
                            (h.prototype._hideModal = function() {
                                ...
                                this._element.setAttribute("aria-hidden", "true"),
                                    (this._isTransitioning = !1),
                                    this._showBackdrop(function() {
                                        t(document.body).removeclassName(m.OPEN),
                                            e._resetAdjustments(),
                                            e._resetScrollbar(),
                            ...
                            (h.prototype._showBackdrop = function(e) {
                                var n = this,
                                    i = t(this._element).hasclassName(m.FADE) ? m.FADE : "";
                                if (this._isShown && this._config.backdrop) {
                                    var o = r.supportsTransitionEnd() && i;
                                    if (
                                        ((this._backdrop = document.createElement("div")),
                                            (this._backdrop.className = m.BACKDROP),
                                            i && t(this._backdrop).addclassName(i),
                                            ...
                                            t(this._backdrop).addclassName(m.SHOW), !e)
                                    )
                                        return;
                                    if (!o) return void e();
                                    t(this._backdrop)
                                    ...
                                    t(this._backdrop).removeclassName(m.SHOW);
                                    var s = function() {
                    ...
                    m = (function() {
                        ...
                        return (
                            ...
                            (h.prototype._activate = function(e) {
                                ...
                                var i = t(n.join(","));
                                i.hasclassName(_.DROPDOWN_ITEM) ?
                                    (i
                                        .closest(g.DROPDOWN)
                                        .find(g.DROPDOWN_TOGGLE)
                                        .addclassName(_.ACTIVE),
                                        i.addclassName(_.ACTIVE)) :
                                    i
                                    .parents(g.LI)
                                    .find("> " + g.NAV_LINKS)
                                    .addclassName(_.ACTIVE),
                            ...
                            (h.prototype._clear = function() {
                                t(this._selector).filter(g.ACTIVE).removeclassName(_.ACTIVE);
                            }),
                            (h._jQueryInterface = function(e) {
                                return this.each(function() {
                                    var n = t(this).data(a),
                ...
                var e = "tab",
                    ...
                    _ = (function() {
                        ...
                        return (
                            (e.prototype.show = function() {
                                ...
                                if (!(
                                        (this._element.parentNode &&
                                            ...
                                            Node.ELEMENT_NODE &&
                                            t(this._element).hasclassName(d.ACTIVE)) ||
                                        t(this._element).hasclassName(d.DISABLED)
                                    )) {
                                    var n = void 0,
                                        i = void 0,
                            ...
                            (e.prototype.dispose = function() {
                                t.removeclassName(this._element, s), (this._element = null);
                            }),
                            (e.prototype._activate = function(e, n, i) {
                                ...
                                s && a ?
                                    ...
                                    l(),
                                    s && t(s).removeclassName(d.SHOW);
                            }),
                            (e.prototype._transitionComplete = function(e, n, i, o) {
                                if (n) {
                                    t(n).removeclassName(d.ACTIVE);
                                    var s = t(n.parentNode).find(f.DROPDOWN_ACTIVE_CHILD)[0];
                                    s && t(s).removeclassName(d.ACTIVE),
                                        n.setAttribute("aria-expanded", !1);
                                }
                                if (
                                    (t(e).addclassName(d.ACTIVE),
                                        e.setAttribute("aria-expanded", !0),
                                        i ?
                                        (r.reflow(e), t(e).addclassName(d.SHOW)) :
                                        t(e).removeclassName(d.FADE),
                                        e.parentNode &&
                                        t(e.parentNode).hasclassName(d.DROPDOWN_MENU))
                                ) {
                                    var a = t(e).closest(f.DROPDOWN)[0];
                                    a && t(a).find(f.DROPDOWN_TOGGLE).addclassName(d.ACTIVE),
                                        e.setAttribute("aria-expanded", !0);
                                }
                                o && o();
                            }),
            ...
            (function(t) {
                ...
                var e = "tooltip",
                    ...
                    d = {
                        animation: !0,
                        template: '<div className="tooltip" role="tooltip"><div className="tooltip-inner"></div></div>',
                        trigger: "hover focus",
                        title: "",
                        delay: 0,
                        html: !1,
                        ...
                        return (
                            ...
                            (h.prototype.toggle = function(e) {
                                if (e) {
                                    ...
                                    if (t(this.getTipElement()).hasclassName(m.SHOW))
                            ...
                            (h.prototype.show = function() {
                                ...
                                if (this.isWithContent() && this._isEnabled) {
                                    ...
                                    o.setAttribute("id", s),
                                        ...
                                        this.setContent(),
                                        this.config.animation && t(o).addclassName(m.FADE);
                                    var a =
                                    ...
                                    t(o).data(this.constructor.DATA_KEY, this).appendTo(c),
                                        ...
                                        (this._tether = new Tether({
                                            ...
                                            addTargetclassNamees: !1,
                                        })),
                                        r.reflow(o),
                                        this._tether.position(),
                                        t(o).addclassName(m.SHOW);
                                    var d = function() {
                                        var n = e._hoverState;
                                        (e._hoverState = null),
                                    ...
                                    if (
                                        r.supportsTransitionEnd() &&
                                        t(this.tip).hasclassName(m.FADE)
                                    )
                                        return (
                                            (this._isTransitioning = !0),
                                            void t(this.tip)
                            ...
                            (h.prototype.setContent = function() {
                                ...
                                this.setElementContent(
                                    ...
                                    e.removeclassName(m.FADE + " " + m.SHOW),
                                    this.cleanupTether();
                            }),
                            ...
                            (h.prototype._enter = function(e, n) {
                                ...
                                return (
                                    ...
                                    t(n.getTipElement()).hasclassName(m.SHOW) ||
                                    n._hoverState === g.SHOW ?
    ...
    (function(r) {
        var a = "popover",
            ...
            d = r.extend({}, s.Default, {
                ...
                trigger: "click",
                content: "",
                template: '<div className="popover" role="tooltip"><h3 className="popover-title"></h3><div className="popover-content"></div></div>',
            }),
                ...
                return (
                    ...
                    (u.prototype.setContent = function() {
                        ...
                        this.setElementContent(t.find(g.TITLE), this.getTitle()),
                            ...
                            t.removeclassName(_.FADE + " " + _.SHOW),
                            this.cleanupTether();
                    }),
