...
!(function(t, i, s) {
    ...
    (i.Isotope.settings = {
        resizable: !0,
        layoutMode: "masonry",
        containerclassName: "isotope",
        itemclassName: "isotope-item",
        hiddenclassName: "isotope-hidden",
    ...
    (i.Isotope.prototype = {
        _create: function(t) {
            ...
            var h = this;
            setTimeout(function() {
                    h.element.addclassName(h.options.containerclassName);
                }, 0),
        ...
        _getAtoms: function(t) {
            ...
            return (
                ...
                s.css(e).addclassName(this.options.itemclassName),
        ...
        _filter: function(t) {
            ...
            if (!i) return t;
            var s = this.options.hiddenclassName,
                e = "." + s,
                n = t.filter(e),
                o = n;
            if ("*" !== i) {
                o = n.filter(i);
                var r = t.not(e).not(i).addclassName(s);
        ...
        _processStyleQueue: function(t, s) {
            ...
            if (
                ...
                n = function(t, i) {
                    (e = i.$el.hasclassName("no-transition") ? "css" : h),
                    i.$el[e](i.style, l);
                };
                ...
                if (
                    ...
                    for (
                        var m, p = 0, v = this.styleQueue[0], _ = v && v.$el; !_ || !_.length;
        ...
        _revealAppended: function(t, i) {
            var s = this;
            setTimeout(function() {
                t.removeclassName("no-transition"),
        ...
        remove: function(t, i) {
            ...
            t.filter(":not(." + this.options.hiddenclassName + ")").length ?
                (this.styleQueue.push({ $el: t, style: this.options.hiddenStyle }),
                    this._sort(),
                    this.reLayout(e)) :
                e();
        ...
        destroy: function() {
            var t = this.usingTransforms,
                i = this.options;
            this.$allAtoms
                .removeclassName(i.hiddenclassName + " " + i.itemclassName)
                .each(function() {
                    var i = this.style;
                    (i.position = ""),
                    (i.top = ""),
            ...
            this.element
                .unbind(".isotope")
                .undelegate("." + i.hiddenclassName, "click")
                .removeclassName(i.containerclassName)
                .removeData("isotope"),
                C.unbind(".isotope");
        },
        ...
        _masonryPlaceBrick: function(t, i) {
            for (
                var s = Math.min.apply(Math, i), e = 0, n = 0, o = i.length; o > n; n++
            )
                if (i[n] === s) {
                    e = n;
                    break;
...
(function($) {
    var $container = $(".portfolio"),
        colWidth = function() {
            ...
            $container.find(".pitem").each(function() {
                var $item = $(this),
                    multiplier_w = $item.attr("className").match(/item-w(\d)/),
                    multiplier_h = $item.attr("className").match(/item-h(\d)/),
                    width = multiplier_w ?
    ...
    $("nav.portfolio-filter ul a").on("click", function() {
        ...
        $("nav.portfolio-filter ul a").removeclassName("active");
