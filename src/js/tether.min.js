!(function(t, e) {
    ...
    function h(t, e) {
        if ("undefined" != typeof t.classNameList)
            e.split(" ").forEach(function(e) {
                e.trim() && t.classNameList.remove(e);
            });
        else {
    ...
    function d(t, e) {
        if ("undefined" != typeof t.classNameList)
            return t.classNameList.contains(e);
        var o = u(t);
    ...
    function v() {
        for (
            var t = { top: 0, left: 0 }, e = arguments.length, o = Array(e), i = 0; e > i; i++
        )
            o[i] = arguments[i];
        return (
    ...
    var M = (function() {
            function t(t, e) {
                ...
                try {
                    for (
                        var s, a = t[Symbol.iterator](); !(i = (s = a.next()).done) &&
                        (o.push(s.value), !e || o.length !== e); i = !0
                    );
                } catch (f) {
                    (n = !0), (r = f);
                } finally {
    ...
    !(function() {
        ...
        "undefined" != typeof window &&
            "undefined" != typeof window.addEventListener && ["resize", "scroll", "touchmove"].forEach(function(t) {
    ...
    var z = { center: "center", left: "right", right: "left" },
        ...
        F = function(t) {
            ...
            return (
                ...
                "undefined" != typeof Y[t.top] && (o = Y[t.top]), { left: e, top: o }
            );
        },
        X = function(t) {
            var e = t.split(" "),
                ...
                w(t, [{
                        ...
                        value: function() {
                            var t =
                                ...
                                "" :
                                arguments[0],
                                e = this.options.classNamees;
                            return "undefined" != typeof e && e[t] ?
                                this.options.classNamees[t] :
                                this.options.classNamePrefix ?
                                this.options.classNamePrefix + "-" + t :
                                t;
                        },
                    },
                    {
                        ...
                        value: function(t) {
                            ...
                            if (
                                ((this.element = s),
                                    ...
                                    l(this.element, this.getclassName("element")),
                                    this.options.addTargetclassNamees !== !1 &&
                                    l(this.target, this.getclassName("target")), !this.options.attachment)
                            )
                        ...
                        value: function() {
                            ...
                            if ("scroll-handle" === this.targetModifier) {
                                ...
                                var i = getComputedStyle(o),
                                    n =
                                    o.scrollWidth > o.clientWidth || [i.overflow, i.overflowX].indexOf("scroll") >= 0 ||
                                    this.target !== document.body,
                                    s = 0;
                                n && (s = 15);
                                var a =
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var t = this,
                                ...
                                arguments[0];
                            this.options.addTargetclassNamees !== !1 &&
                                l(this.target, this.getclassName("enabled")),
                                l(this.element, this.getclassName("enabled")),
                                (this.enabled = !0),
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var t = this;
                            h(this.target, this.getclassName("enabled")),
                                h(this.element, this.getclassName("enabled")),
                                (this.enabled = !1),
                    ...
                    {
                        key: "updateAttachclassNamees",
                        value: function(t, e) {
                            var o = this;
                            (t = t || this.attachment), (e = e || this.targetAttachment);
                            var i = ["left", "top", "bottom", "right", "middle", "center"];
                            "undefined" != typeof this._addAttachclassNamees &&
                                this._addAttachclassNamees.length &&
                                this._addAttachclassNamees.splice(
                                    0,
                                    this._addAttachclassNamees.length
                                ),
                                "undefined" == typeof this._addAttachclassNamees &&
                                (this._addAttachclassNamees = []);
                            var n = this._addAttachclassNamees;
                            t.top &&
                                n.push(this.getclassName("element-attached") + "-" + t.top),
                                t.left &&
                                n.push(this.getclassName("element-attached") + "-" + t.left),
                                e.top &&
                                n.push(this.getclassName("target-attached") + "-" + e.top),
                                e.left &&
                                n.push(this.getclassName("target-attached") + "-" + e.left);
                            var r = [];
                            i.forEach(function(t) {
                                    r.push(o.getclassName("element-attached") + "-" + t),
                                        r.push(o.getclassName("target-attached") + "-" + t);
                                }),
                                T(function() {
                                    "undefined" != typeof o._addAttachclassNamees &&
                                        (c(o.element, o._addAttachclassNamees, r),
                                            o.options.addTargetclassNamees !== !1 &&
                                            c(o.target, o._addAttachclassNamees, r),
                                            delete o._addAttachclassNamees);
                                });
                        },
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (this.enabled) {
                                ...
                                this.updateAttachclassNamees(this.attachment, o);
                            ...
                            if ("undefined" != typeof this.element.parentNode) {
                                ...
                                if (
                                    ((o.page.top || o.page.bottom) &&
                                        ...
                                        ((l.position = "absolute"),
                                            d({ top: !0, left: !0 }, t.page)), !u)
                                ) {
                                    for (
                                        var p = !0, c = this.element.parentNode; c && "BODY" !== c.tagName;
    ...
    C.modules.push({
        position: function(t) {
            ...
            var d = this.cache("target-bounds", function() {
                ...
                u = d.height,
                p = d.width,
                g = [this.getclassName("pinned"), this.getclassName("out-of-bounds")];
            this.options.constraints.forEach(function(t) {
                    var e = t.outOfBoundsclassName,
                        o = t.pinnedclassName;
                ...
                this.options.constraints.forEach(function(t) {
                    ...
                    o < w[1] &&
                        ...
                        !(function() {
                            var t = void 0;
                            (t =
                                "undefined" != typeof e.options.pinnedclassName ?
                                e.options.pinnedclassName :
                                e.getclassName("pinned")),
                            m.push(t),
                        ...
                        !(function() {
                            var t = void 0;
                            (t =
                                "undefined" != typeof e.options.outOfBoundsclassName ?
                                e.options.outOfBoundsclassName :
                                e.getclassName("out-of-bounds")),
                            m.push(t),
                                O.forEach(function(e) {
                                    m.push(t + "-" + e);
                                });
                        ...
                        e.updateAttachclassNamees(y, v);
                }),
                T(function() {
                    e.options.addTargetclassNamees !== !1 && c(e.target, m, g),
                        c(e.element, m, g);
                }), { top: o, left: i }
            );
        },
    ...
    C.modules.push({
        position: function(t) {
            var e = this,
                ...
                d = [];
            o <= f.bottom &&
                h >= f.top && ["left", "right"].forEach(function(t) {
                    var e = f[t];
                    (e === i || e === l) && d.push(t);
                }),
                i <= f.right &&
                l >= f.left && ["top", "bottom"].forEach(function(t) {
                    var e = f[t];
                    (e === o || e === h) && d.push(t);
                });
            var u = [],
            ...
            return (
                u.push(this.getclassName("abutted")),
                g.forEach(function(t) {
                    u.push(e.getclassName("abutted") + "-" + t);
                }),
                d.length && p.push(this.getclassName("abutted")),
                d.forEach(function(t) {
                    p.push(e.getclassName("abutted") + "-" + t);
                }),
                T(function() {
                    e.options.addTargetclassNamees !== !1 && c(e.target, p, u),
                        c(e.element, p, u);
                }), !0
            );
        },
    ...
    var M = (function() {
        function t(t, e) {
            ...
            try {
                for (
                    var s, a = t[Symbol.iterator](); !(i = (s = a.next()).done) && (o.push(s.value), !e || o.length !== e); i = !0
                );
            } catch (f) {
                (n = !0), (r = f);
            } finally {
