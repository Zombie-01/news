    ...
    (this.WOW = (function() {
        function e(a) {
            null == a && (a = {}),
                ...
                (this.wowEvent = this.util().createEvent(this.config.boxclassName));
        }
        return (
            ...
            (e.prototype.doSync = function(a) {
                ...
                if ((null == a && (a = this.element), 1 === a.nodeType)) {
                    for (
                        a = a.parentNode || a,
                        e = a.querySelectorAll("." + this.config.boxclassName),
                        f = [],
                        c = 0,
                        d = e.length; d > c; c++
                    )
            ...
            (e.prototype.show = function(a) {
                return (
                    this.applyStyle(a),
                    (a.className = a.className + " " + this.config.animateclassName),
                ...
                return a.type.toLowerCase().indexOf("animationend") >= 0 ?
                    ((b = a.target || a.srcElement),
                        (b.className = b.className
                            .replace(this.config.animateclassName, "")
                            .trim())) :
                    void 0;
            }),
